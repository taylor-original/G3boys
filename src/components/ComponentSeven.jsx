...
const SeventhPart = () => {
    return (
			<div className='seventh-container'>
				...
				<div className='seventh-container-content'>
					<div className='seventh-container-content-container'>
						<div className='seventh-container-content-container-icon'>
						...
						<div className='seventh-container-content-container-details'>
							<h2>Create an account</h2>
						</div>
					</div>
					<div className='seventh-container-content-divider-container'>
						<div className='seventh-container-content-divider'></div>
					</div>
					<div className='seventh-container-content-container'>
						<div className='seventh-container-content-container-icon'>
